...
static void SPCDECL sp_interface_finalizer(void *obj_data, void *type_data)
{
  ...
  fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) ref before == %ld\n", (unsigned long) pUnkn, tmp);fflush(stderr);
#endif

  tmp = IUnknown_Release(pUnkn);

#if COMCLIENT_DEBUG
  fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) ref after == %ld\n", (unsigned long) pUnkn, tmp);fflush(stderr);
#endif
  ...
  if (pObj)
    {
      ...
      tmp = IUnknown_AddRef(pUnkn);
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_AddRef(0x%lx) == %ld\n", (unsigned long) pUnkn, tmp);fflush(stderr);
#endif
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pUnkn, tmp);fflush(stderr);
#endif
    }
  return pObj;
}
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pItf, tmp);fflush(stderr);
#endif      
    }
  if (pObj)
    {
...
#if COMCLIENT_DEBUG
          fprintf(stderr, "DBG COMCLIENT: ITypeInfo_Release(0x%lx) == %ld\n", (unsigned long) pTInfo, tmp);fflush(stderr);
#endif
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IDispatch_Release(0x%lx) == %ld\n", (unsigned long) pDsp, tmp);fflush(stderr);
#endif
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pUnkn1a, tmp);fflush(stderr);
#endif
    }
  if (pUnkn1b)
    {
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pUnkn1b, tmp);fflush(stderr);
#endif
    }
  if (pUnkn2a)
    {
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pUnkn2a, tmp);fflush(stderr);
#endif
    }
  if (pUnkn2b)
    {
...
#if COMCLIENT_DEBUG
      fprintf(stderr, "DBG COMCLIENT: IUnknown_Release(0x%lx) == %ld\n", (unsigned long) pUnkn2b, tmp);fflush(stderr);
#endif
    }
  *pResult = result;
}
