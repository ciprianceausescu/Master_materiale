...
char SP_FLI_CONST * SPCDECL _Sget_string(char *pointer, long offset)
{
	return *(char **)(pointer+offset);
}


long SPCDECL _Sget_integer(pointer, offset)
char *pointer;
long offset;
{
...
long SPCDECL _Sget_integer_32(pointer, offset)
char *pointer;
long offset;
{
...
long SPCDECL _Sget_integer_16(pointer, offset)
char *pointer;
long offset;
{
...
long SPCDECL _Sget_integer_8(pointer, offset)
char *pointer;
long offset;
{
...
long SPCDECL _Sget_unsigned(pointer, offset, mask)
char *pointer;
long offset;
long *mask;
{
        *mask = SIGNMASK;
	return *(unsigned long *)(pointer+offset);
}


long SPCDECL _Sget_unsigned_32(pointer, offset, mask)
char *pointer;
long offset;
long *mask;
{
...
long SPCDECL _Sget_unsigned_16(pointer, offset)
char *pointer;
long offset;
{
...
long SPCDECL _Sget_unsigned_8(pointer, offset)
char *pointer;
long offset;
{
...
void SPCDECL _Sput_string(char *pointer, long offset, char SP_FLI_CONST *newvalue)
{
...
void SPCDECL _Sput_integer(char *pointer, long offset, long newvalue)
{
	(*(long *)(pointer+offset)) = newvalue;
}
...
void * SPCDECL _Scalloc(long count, long size)
{
