...
foreign_resource(structs, ['_Sget_atom', '_Sget_string',
'_Sget_integer', '_Sget_integer_32', '_Sget_integer_16', '_Sget_integer_8',
'_Sget_unsigned', '_Sget_unsigned_32', '_Sget_unsigned_16', '_Sget_unsigned_8',
'_Sget_float', '_Sget_float_32', '_Sput_atom', '_Sput_string',
'_Sput_integer', '_Sput_integer_32', '_Sput_integer_16', '_Sput_integer_8',
'_Sput_unsigned', '_Sput_unsigned_32', '_Sput_unsigned_16', '_Sput_unsigned_8',
...
foreign('_Sput_integer', c, put_integer(+address(char), +integer, +integer)).
foreign('_Sput_integer_32', c, put_integer_32(+address(char), +integer, +integer)).
foreign('_Sput_integer_16', c, put_integer_16(+address(char), +integer, +integer)).
foreign('_Sput_integer_8', c, put_integer_8(+address(char), +integer, +integer)).
foreign('_Sput_unsigned', c, put_unsigned(+address(char), +integer, +integer)).
foreign('_Sput_unsigned_32', c, put_unsigned_32(+address(char), +integer, +integer)).
foreign('_Sput_unsigned_16', c, put_unsigned_16(+address(char), +integer, +integer)).
foreign('_Sput_unsigned_8', c, put_unsigned_8(+address(char), +integer, +integer)).
