...
wait_for_arrival(Socket, Streams0, ReadableStreams, Streams) :-
        Timeout = 'off',
        trace_linda(before,socket_select([Socket], Connecting, Streams0,ReadableStreams, [],_WR, Timeout),Ti),
	socket_select([Socket], Connecting, Streams0,ReadableStreams, [],_, Timeout),
        trace_linda(after,socket_select([Socket], Connecting, Streams0,ReadableStreams, [],_WR, Timeout),Ti),
