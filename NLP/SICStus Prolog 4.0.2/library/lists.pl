...
%@  each of @var{L1}, ..., @var{Ln} should be a proper list.  The behaviour on
...
%@  @PLXindex {cumlist/4 (lists)}
%@  maps a ternary predicate @var{Pred} down the list @var{[X1,...,Xn]} just as
%@  @code{scanlist/4} does, and returns a list of the results.  It terminates
%@  when either list runs out.  If @var{Pred} is bidirectional, it may be
...
%@  @item scanlist(@var{:Pred}, @var{+List}, @var{?V1}, @var{?V})
%@  @PLXindex {scanlist/4 (lists)}
%@  maps a ternary relation @var{Pred} down a list.  If the list is
%@  @var{[X1,X2,...,Xn]}, the computation is
%@  @var{Pred(X1,V1,V2)}, @var{Pred(X2,V2,V3)}, ..., @var{Pred(Xn,Vn,V)}
%@  So if @var{Pred} is @code{plus/3}, @code{scanlist(plus, List, 0, V)} puts the
...
%@  @item exclude(@var{:Pred}, @var{+List}, @var{?SubList})
%@  @PLXindex {exclude/[3,4,5] (lists)}
%@  succeeds when @var{SubList} is the @var{SubList} of @var{List} containing all the
%@  elements for which @var{Pred(Elem)} is @emph{false}.  That is, it removes
%@  all the elements satisfying @var{Pred}.  @var{List} should be a proper list.
...
%@  @item exclude(@var{:Pred}, @var{+Xs}, @var{+Ys}, @var{+Es})
...
%@  @item exclude(@var{:Pred}, @var{+Xs}, @var{+Ys}, @var{+Zs}, @var{+Es})
%@  is true when @var{Es} is the sublist of @var{Xs} containing all the elements @var{Xi}
%@  for which @var{Pred(Xi, Yi, Zi)} is @emph{false}.  @var{Xs} should be a proper list,
%@  and @var{Ys} and @var{Zs} should be at least as long as @var{Xs} (they may be longer).
...
%@  @item include(@var{:Pred}, @var{+List}, @var{?SubList})
%@  @PLXindex {include/[3,4,5] (lists)}
%@  succeeds when @var{SubList} is the @var{SubList} of @var{List} containing all the
%@  elements for which @var{Pred(Elem)} is @emph{true}.  That is, it retains
%@  all the elements satisfying @var{Pred}.  @var{List} should be a proper list.
...
%@  @item include(@var{:Pred}, @var{+Xs}, @var{+Ys}, @var{+Es})
%@  is true when @var{Es} is the sublist of @var{Xs} containing all the elements @var{Xi}
%@  for which @var{Pred(Xi, Yi)} is @emph{true}.   @var{Xs} should be a proper list, and
%@  @var{Ys} should be at least as long as @var{Xs} (it may be longer).
...
%@  @item include(@var{:Pred}, @var{+Xs}, @var{+Ys}, @var{+Zs}, @var{+Es})
%@  is true when @var{Es} is the sublist of @var{Xs} containing all the elements @var{Xi}
%@  for which @var{Pred(Xi, Yi, Zi)} is @emph{false}.  @var{Xs} should be a proper list,
%@  and @var{Ys} and @var{Zs} should be at least as long as @var{Xs} (they may be longer).
