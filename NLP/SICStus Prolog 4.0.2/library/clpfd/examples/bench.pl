...
benches(default,
	[heur_queens([ff],8),
	 ...
	 partit([ff],8,bound),
	 partit([ff,discrepancy(3)],16,bound),
	 partit([ff,discrepancy(4)],24,bound),
	 partit([ff,discrepancy(5)],32,bound),
...
benches(Key,
	[heur_queens([ff],8),
	 ...
	 partit([ff],8,Key),
	 partit([ff,discrepancy(3)],16,Key),
	 partit([ff,discrepancy(4)],24,Key),
	 partit([ff,discrepancy(5)],32,Key),
	 donald([ff,down], Key),
