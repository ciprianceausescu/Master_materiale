...
search(Tertiary, NegErg) :-
	findall(f(Tertiary,NegErg), once(labeling([],Tertiary)), [f(Tert0,NegErg0)]),
	search(Tert0, NegErg0, Tertiary, NegErg).

search(Tert0, NegErg0, Tertiary, NegErg) :-
	NegErg0 #< NegErg,
	lex_chain([Tert0,Tertiary]),
	findall(f(Tertiary,NegErg), once(labeling([],Tertiary)), [f(Tert1,NegErg1)]), !,
	search(Tert1, NegErg1, Tertiary, NegErg).
search(Tertiary, NegErg, Tertiary, NegErg).
