...
#if SPIO_DEBUG
#define SPIO_E_ERROR_1 -50001
#define SPIO_E_ERROR_2 -50002
#define SPIO_E_ERROR_3 -50003
#define SPIO_E_ERROR_4 -50004
#define SPIO_E_ERROR_5 -50005
#define SPIO_E_ERROR_6 -50006
#define SPIO_E_ERROR_7 -50007
#else
...
#define SPIO_SUCCEEDED(CODE) (!SPIO_FAILED((CODE)))
  ...
  SPIO_E_NET_           = -10600, /* starting point for network errors */
