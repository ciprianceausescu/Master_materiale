...
#if 0                           /* decode is now a required capability */
#define SPIO_CHAR_CODER_FUNCS_FEATURE_CAN_DECODE SPIO_BIT(0) /* accepts SPIO_CHAR_CODER_OPEN_OPTION_DECODE */
#endif  /* 0 */
...
#define SPIO_CHAR_CODER_OPEN_OPTION_DECODE        SPIO_NEXT_BIT(SPIO_CHAR_CODER_OPEN_OPTION_SEEKABLE_BACK) /* decode from bytes to INTERNAL wchar */
