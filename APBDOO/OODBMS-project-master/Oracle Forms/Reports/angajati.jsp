...
<report name="angajati" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL FOTBALIST.ID_FOTBALIST, 
FOTBALIST.NUME, FOTBALIST.PRENUME, FOTBALIST.DATA_NASTERII, FOTBALIST.NATIONALITATE, 
FOTBALIST.COTA, FOTBALIST.ID_CONTRACT, FOTBALIST.ID_IMPRESAR
FROM FOTBALIST ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_ID_FOTBALIST">
        <displayInfo x="1.19421" y="1.94995" width="1.61169" height="1.69922"
        />
        <dataItem name="ID_FOTBALIST" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="40000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Id Fotbalist">
          <dataDescriptor expression="FOTBALIST.ID_FOTBALIST"
           descriptiveExpression="ID_FOTBALIST" order="1" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NUME" datatype="vchar2" columnOrder="12" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nume">
          <dataDescriptor expression="FOTBALIST.NUME"
           descriptiveExpression="NUME" order="2" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PRENUME" datatype="vchar2" columnOrder="13" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Prenume">
          <dataDescriptor expression="FOTBALIST.PRENUME"
           descriptiveExpression="PRENUME" order="3" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DATA_NASTERII" datatype="date" oracleDatatype="date"
         columnOrder="14" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Data Nasterii">
          <dataDescriptor expression="FOTBALIST.DATA_NASTERII"
           descriptiveExpression="DATA_NASTERII" order="4" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NATIONALITATE" datatype="vchar2" columnOrder="15"
         width="15" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Nationalitate">
          <dataDescriptor expression="FOTBALIST.NATIONALITATE"
           descriptiveExpression="NATIONALITATE" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COTA" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="120000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Cota">
          <dataDescriptor expression="FOTBALIST.COTA"
           descriptiveExpression="COTA" order="6" width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_CONTRACT" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="50000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Id Contract">
          <dataDescriptor expression="FOTBALIST.ID_CONTRACT"
           descriptiveExpression="ID_CONTRACT" order="7" width="22"
           precision="3"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_IMPRESAR" oracleDatatype="number" columnOrder="18"
         width="22" defaultWidth="40000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Id Impresar">
          <dataDescriptor expression="FOTBALIST.ID_IMPRESAR"
           descriptiveExpression="ID_IMPRESAR" order="8" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
  ...
  <section name="main">
    <body>
      <frame name="M_G_ID_FOTBALIST_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.81250" height="0.37500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_ID_FOTBALIST" source="G_ID_FOTBALIST"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="6.81250"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_ID_FOTBALIST" source="ID_FOTBALIST" minWidowLines="1"
          ...
          <field name="F_NUME" source="NUME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="0.68750" y="0.18750" width="0.62500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_PRENUME" source="PRENUME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="9"/>
          ...
          <field name="F_DATA_NASTERII" source="DATA_NASTERII"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="1.93750" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_NATIONALITATE" source="NATIONALITATE"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="9"/>
          ...
          <field name="F_COTA" source="COTA" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="3.87500" y="0.18750" width="1.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ID_CONTRACT" source="ID_CONTRACT" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="5.43750" y="0.18750" width="0.68750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ID_IMPRESAR" source="ID_IMPRESAR" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="6.12500" y="0.18750" width="0.68750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_ID_FOTBALIST_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="6.81250"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="allPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableHeading"/>
          <text name="B_ID_FOTBALIST" minWidowLines="1">
          ...
          <text name="B_PRENUME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.31250" y="0.00000" width="0.62500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
          ...
          <text name="B_DATA_NASTERII" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.93750" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
          ...
          <text name="B_NATIONALITATE" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_COTA" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.87500" y="0.00000" width="1.56250"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
          ...
          <text name="B_ID_CONTRACT" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.43750" y="0.00000" width="0.68750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
          ...
          <text name="B_ID_IMPRESAR" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.12500" y="0.00000" width="0.68750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwbeige" sectionTitle="Angajati"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGIDFOTBALISTGRPFR46">
<table class="OraTable">
<caption> Angajati </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBIDFOTBALIST46" asArray="no"/> class="OraColumnHeader"> Id Fotbalist </th>
   <th <rw:id id="HBNUME46" asArray="no"/> class="OraColumnHeader"> Nume </th>
   <th <rw:id id="HBPRENUME46" asArray="no"/> class="OraColumnHeader"> Prenume </th>
   <th <rw:id id="HBDATANASTERII46" asArray="no"/> class="OraColumnHeader"> Data Nasterii </th>
   <th <rw:id id="HBNATIONALITATE46" asArray="no"/> class="OraColumnHeader"> Nationalitate </th>
   <th <rw:id id="HBCOTA46" asArray="no"/> class="OraColumnHeader"> Cota </th>
   <th <rw:id id="HBIDCONTRACT46" asArray="no"/> class="OraColumnHeader"> Id Contract </th>
   <th <rw:id id="HBIDIMPRESAR46" asArray="no"/> class="OraColumnHeader"> Id Impresar </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGIDFOTBALIST461" src="G_ID_FOTBALIST">
   <tr>
    <td <rw:headers id="HFIDFOTBALIST46" src="HBIDFOTBALIST46"/> class="OraCellNumber"><rw:field id="FIDFOTBALIST46" src="ID_FOTBALIST" nullValue="&nbsp;"> F_ID_FOTBALIST </rw:field></td>
    <td <rw:headers id="HFNUME46" src="HBNUME46"/> class="OraCellText"><rw:field id="FNUME46" src="NUME" nullValue="&nbsp;"> F_NUME </rw:field></td>
    <td <rw:headers id="HFPRENUME46" src="HBPRENUME46"/> class="OraCellText"><rw:field id="FPRENUME46" src="PRENUME" nullValue="&nbsp;"> F_PRENUME </rw:field></td>
    <td <rw:headers id="HFDATANASTERII46" src="HBDATANASTERII46"/> class="OraCellText"><rw:field id="FDATANASTERII46" src="DATA_NASTERII" nullValue="&nbsp;"> F_DATA_NASTERII </rw:field></td>
    <td <rw:headers id="HFNATIONALITATE46" src="HBNATIONALITATE46"/> class="OraCellText"><rw:field id="FNATIONALITATE46" src="NATIONALITATE" nullValue="&nbsp;"> F_NATIONALITATE </rw:field></td>
    <td <rw:headers id="HFCOTA46" src="HBCOTA46"/> class="OraCellNumber"><rw:field id="FCOTA46" src="COTA" nullValue="&nbsp;"> F_COTA </rw:field></td>
    <td <rw:headers id="HFIDCONTRACT46" src="HBIDCONTRACT46"/> class="OraCellNumber"><rw:field id="FIDCONTRACT46" src="ID_CONTRACT" nullValue="&nbsp;"> F_ID_CONTRACT </rw:field></td>
    <td <rw:headers id="HFIDIMPRESAR46" src="HBIDIMPRESAR46"/> class="OraCellNumber"><rw:field id="FIDIMPRESAR46" src="ID_IMPRESAR" nullValue="&nbsp;"> F_ID_IMPRESAR </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
